...
const DTIBacktester = {
    ...
    init: function() {
        ...
        document.getElementById('process-btn').addEventListener('click', this.handleProcessButtonClick.bind(this));
